...
class Step6LogRotate extends Step0Base {
  ...
  public function run() : bool {
    ...
    $this->exec(['cp', '/opt/srvr/accets/etc/logrotate.d/exim', '/etc/logrotate.d/exim']);
    $this->exec(['cp', '/opt/srvr/accets/etc/logrotate.d/docker-proxy', '/etc/logrotate.d/docker-proxy']);
